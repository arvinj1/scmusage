...
def incAug18():
    global counterAug2018
    counterAug2018=counterAug2018+1
...
def incMar18():
    global counterMarch2018
    counterMarch2018=counterMarch2018+1
...
def incSep18 ():
    global counterSept2018
    counterSept2018=counterSept2018+1    
    ...
    for click in clickBaits:
        if customDate == True:
           ...
           # d=d+datetime.timedelta(hours=-4)    
            ...
            #tomorrow=tomorrow+datetime.timedelta(hours=-4)
...
def formatOutput (currentMonth=False,selfieOnly=False,textOnly=False, customDate=False):
    ...
    for clickBait in clickBaits:
        ...
        try:
            ...
            #else:
            #    print (caption,counterSept2018)
            i=i+1
            #print(captions[i])
            globalStats[clickBait]=counterSept2018
